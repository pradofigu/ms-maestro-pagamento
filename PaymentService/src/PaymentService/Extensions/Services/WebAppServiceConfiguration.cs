...
public static class WebAppServiceConfiguration
{
    public static void ConfigureServices(this WebApplicationBuilder builder)
    {
        ...
        builder.Services.AddCorsService("PaymentServiceCorsPolicy", builder.Environment);
        builder.OpenTelemetryRegistration(builder.Configuration, "PaymentService");
        ...
        // registers all services that inherit from your base service interface - IPaymentServiceScopedService
    ...
    private static void AddBoundaryServices(this IServiceCollection services, params Assembly[] assemblies)
    {
        ...
        foreach (var assembly in assemblies)
        {
            var rules = assembly.GetTypes()
                .Where(x => !x.IsAbstract && x.IsClass && x.GetInterface(nameof(IPaymentServiceScopedService)) == typeof(IPaymentServiceScopedService));

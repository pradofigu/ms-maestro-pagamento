namespace PaymentService.Extensions.Services.ConsumerRegistrations;
...
{
    public static void OrderCreatedEndpoint(this IRabbitMqBusFactoryConfigurator cfg, IBusRegistrationContext context)
    {
        cfg.ReceiveEndpoint("order-created-queue", re =>
        {
            ...
            re.ConfigureConsumer<OrderCreated>(context);

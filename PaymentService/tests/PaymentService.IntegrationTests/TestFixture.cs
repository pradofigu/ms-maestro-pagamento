...
using PaymentService.Extensions.Services;
using PaymentService.Databases;
using PaymentService.Resources;
using PaymentService.SharedTestHelpers.Utilities;
...
public class TestFixture : IAsyncLifetime
{
    ...
    public async Task InitializeAsync()
    {
        ...
        builder.Configuration.GetSection(ConnectionStringOptions.SectionName)[ConnectionStringOptions.PaymentServiceKey] = _dbContainer.GetConnectionString();
    ...
    private static async Task RunMigration(string connectionString)
    {
        var options = new DbContextOptionsBuilder<PaymentDbContext>()
            ...
            .Options;
        var context = new PaymentDbContext(options, null, null, null);
